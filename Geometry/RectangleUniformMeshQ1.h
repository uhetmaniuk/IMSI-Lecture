#ifndef FECODE_GEOMETRY_RECTANGLE_UNIFORM_MESH_Q1_H
#define FECODE_GEOMETRY_RECTANGLE_UNIFORM_MESH_Q1_H

#include "Geometry/SimpleGeometry.h"

namespace FECode {

  //! A class generating a Q1 uniform mesh on a rectangle.

  /// ...
  /// ...
  class RectangleUniformMeshQ1: public SimpleGeometry {
    ...
    public:
      ...
      /// Constructor
      RectangleUniformMeshQ1(unsigned int n_X, double L_x, unsigned int n_Y, double L_y);
