#ifndef FECODE_GEOMETRY_BRICK_UNIFORM_MESH_Q2_H
#define FECODE_GEOMETRY_BRICK_UNIFORM_MESH_Q2_H

#include "Geometry/SimpleGeometry.h"

namespace FECode {

  //! A class generating a Q2 uniform mesh on a brick (27 nodes).

  /// ...
  /// ...
  class BrickUniformMeshQ2: public SimpleGeometry {
    ...
    public:
      ...
      /// Constructor
      BrickUniformMeshQ2(unsigned int n_X, double L_x, unsigned int n_Y, double L_y,
