#ifndef FECODE_GEOMETRY_BAR_UNIFORM_MESH_Q1_H
#define FECODE_GEOMETRY_BAR_UNIFORM_MESH_Q1_H
...
namespace FECode {
  ...
  //! A class generating a Q1 mesh on an interval [0, Lx]

  /// ...
  /// ...
  class BarUniformMeshQ1: public SimpleGeometry {
    ...
    public:
      ...
      /// Constructor
      BarUniformMeshQ1(unsigned int nEle, double L_X = 1.0);
