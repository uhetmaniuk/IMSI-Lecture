#ifndef FECODE_FE_3DP2_H
#define FECODE_FE_3DP2_H
...
namespace FECode {
  ...
  //! A class for three-dimensional P2 finite element.
  
  /// The class defines the shape functions for the quadratic
  /// isoparametric element.
  ///
  class fe3DP2: public virtual LagrangeElement {
  ...
  private:
    ...
    fe3DP2(const fe3DP2 &ref);
    fe3DP2 & operator[](const fe3DP2 &ref);
