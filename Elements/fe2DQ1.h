#ifndef FECODE_FE_2DQ1_H
#define FECODE_FE_2DQ1_H
...
namespace FECode {
  ...
  ///
  class fe2DQ1: public virtual LagrangeElement {
  ...
  private:
    ...
    fe2DQ1(const fe2DQ1 &ref);
    fe2DQ1 & operator[](const fe2DQ1 &ref);
