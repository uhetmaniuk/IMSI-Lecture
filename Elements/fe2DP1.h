#ifndef FECODE_FE_2DP1_H
#define FECODE_FE_2DP1_H
...
namespace FECode {
  ...
  //! A class for two-dimensional P1 finite element.
  ...
  ///    1 -- 2
  ///
  class fe2DP1: public virtual LagrangeElement {
  ...
  private:
    ...
    fe2DP1(const fe2DP1 &ref);
    fe2DP1 & operator[](const fe2DP1 &ref);
