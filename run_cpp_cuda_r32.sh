#!/bin/bash
#
# C++ CUDA Scaling Study for MFEM Assembly - RATIO=32
# Tests problem size scaling and compares with OpenMP baseline
#
# IMPORTANT: Before running this script, you must recompile with ratio=32
#   Edit src/ScaledLaplacian.h line 144: static constexpr int ratio = 32;
#   Then: cd build && cmake .. && make cuda_assembly openmp_assembly
#

OUTPUT_DIR="cpp_cuda_scaling_results_r32"
RATIO=32
