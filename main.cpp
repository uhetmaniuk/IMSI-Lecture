...
int main(int argc, char *argv[]) {
    ...
    Kokkos::initialize(argc, argv);
    {
        ...
        Kokkos::View<double*, execution_space> u("Value for approximation", myMesh.NumberVertices());
        {
            ...
            //
            Kokkos::parallel_for("Fill free Matrix", Kokkos::RangePolicy<execution_space>(0, size(freeToGlobal)),
                    KOKKOS_LAMBDA(int iFree){
            ...
            Kokkos::parallel_for("Fill u", Kokkos::RangePolicy<execution_space>(0, size(freeToGlobal)),
                                 KOKKOS_LAMBDA(int i){
