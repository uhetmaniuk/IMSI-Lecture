...
************************************************************************
************************************************************************
*****  ZBLKSLVN ... Block multiple triangular solutions            *****
************************************************************************
************************************************************************
*
*  --------
...
*
*     LNZ         (input) complex double precision array, dimension XLNZ(N+1)-1
...
*
*     RHS         (input) complex double precision array, dimension LRHS by NRHS
*                 The right hand side array.
*
*     LSOLN       (input) integer
*                 Leading dimension of SOLN.
*
*     SOLN        (output) complex double precision array, 
*                 Dimension LRHS by NRHS
*                 The solution array; can be the same as RHS.
*
*     LTEMP       (input) integer
*                 Leading dimension of TEMP.
*
*     TEMP        (temporary) complex double precision array, 
*                 Dimension LTEMP by NRHS
...
*     -------------------
      ...
      INTEGER                 XLINDX(*)     , XLNZ(*)
      COMPLEX*16              LNZ(*)
      COMPLEX*16              RHS(LRHS,*)   , SOLN(LSOLN,*)
      COMPLEX*16              TEMP(LTEMP,*)
*
************************************************************************
*
*     --------------
