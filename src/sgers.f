...
*  =======
*
*  SGERS solves a real general linear system using the triangular
...
*
*  A       (input) single precision array, dimension (LDA,N)
...
*
        CALL  SLASWP ( NRHS, B, LDB, 1, N, IPROW, 1 )
*
...
*
        CALL  SLASWP ( NRHS, B, LDB, 1, N, IPCOL, -1 )
*
        RETURN
*
*       End of SGERS
