...
*     linear system.  It uses output from SBLKLDL.
*
*  ----------
*  Arguments:
*  ----------
...
*
*     RHS         (input) single precision array, dimension LRHS by N
*                 The right hand side array.
*
*     LSOLN       (input) integer
*                 Leading dimension of SOLN.
*
*     SOLN        (output) single precision array, dimension LRHS by N
...
*
*     NTEMP       (input) integer
*                 Number of columns in TEMP; can be <= NRHS.
*
*     TEMP        (temporary) single precision array, dimension
*                 LTEMP by N
...
*     ------------------------
      EXTERNAL                SGEMM, SGEMV , SGERS , STRSM
*
************************************************************************
*
