...
************************************************************************
************************************************************************
*** ZBLKLDL ... block general sparse Cholesky factorization (complex) **
************************************************************************
************************************************************************
*
*   --------
...
*     factorization subroutine, ZBLKL2, to compute a LDL'
*     factorization (symmetric complex matrix).
*
*   ----------
*   Arguments:
*   ----------
...
************************************************************************
*
      SUBROUTINE  ZBLKLDL  ( NPANEL, XPANEL, PNODE , XLINDX, LINDX , 
...
*
        ...
        IF  ( IWSIZE .LT. 2*(N+NPANEL) )  THEN
            ...
            RETURN
        END IF
        CALL  ZBLKL2 ( NPANEL, XPANEL, PNODE, XLINDX, LINDX, XLNZ,
