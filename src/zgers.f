...
*  =======
*
*  ZGERS solves a complex general linear system using the triangular
*  factorization computed by ZGECP.
*
...
*
        CALL  ZLASWP ( NRHS, B, LDB, 1, N, IPROW, 1 )
*
...
*
        CALL  ZLASWP ( NRHS, B, LDB, 1, N, IPCOL, -1 )
*
        RETURN
*
*       End of ZGERS
