...
************************************************************************
************************************************************************
*****  ZBLKSLV3 ... block triangular solutions (complex)           *****
************************************************************************
************************************************************************
*
*   --------
...
*     this subroutine performs the triangular solution for 3 vectors.
...
*
*     R1 - R3   (input) COMPLEX*16 array, dimension N
*               The right hand side vectors.
*
*     S1 - S3   (output) COMPLEX*16 array, dimension N
*               The solution vectors.
*
*     T1 - T3   (temporary) COMPLEX*16 array, dimension N
*               Temporary work arrays.
*
************************************************************************
*
      SUBROUTINE  ZBLKSLV3 ( NPANEL, XPANEL, XLINDX, LINDX , XLNZ  ,
