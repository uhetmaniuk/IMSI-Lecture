...
************************************************************************
************************************************************************
*****  SBLKLDL ... block general sparse Cholesky factorization     *****
************************************************************************
************************************************************************
*
*   --------
...
*     factorization subroutine, SBLKL2, to compute a LDL'
*     factorization.
*
*   ----------
*   Arguments:
...
*
*     LNZ       (input/output) real precision array, dimension
*                   XLNZ(N+1)-1
...
*
*     TEMP      (temporary) real precision array, dimension TMPSIZ
*               Work space for SBLKLDL.
*
...
*
*     RWORK     (temporary) real precision array, dimension RWSIZE
...
************************************************************************
*
      SUBROUTINE SBLKLDL  ( NPANEL, XPANEL, PNODE , XLINDX, LINDX , 
...
*
        ...
        IF  ( IWSIZE .LT. 2*(N+NPANEL) )  THEN
            ...
            RETURN
        END IF
        CALL SBLKL2 ( NPANEL, XPANEL, PNODE, XLINDX, LINDX, XLNZ,
