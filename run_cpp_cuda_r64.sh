#!/bin/bash
#
# C++ CUDA Scaling Study for MFEM Assembly - RATIO=64
# Tests problem size scaling and compares with OpenMP baseline
#
# IMPORTANT: Before running this script, you must recompile with ratio=64
#   Edit src/ScaledLaplacian.h line 144: static constexpr int ratio = 64;
#   Then: cd build && cmake .. && make cuda_assembly openmp_assembly
#

OUTPUT_DIR="cpp_cuda_scaling_results_r64"
RATIO=64
...
echo "  ./run_cpp_cuda_r16.sh    # ratio=16"
